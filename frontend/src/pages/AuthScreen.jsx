  ...
  return (
    <div className="hero-bg relative">
      ...
      <div className="flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto">
        ...
        <p className="text-lg mb-4">Watch anywere. Cancel anytime.</p>
        <p className="mb-4">Ready to watch? Enter your email to create or restart your membership.</p>

        <form action="" className="flex flex-col md:flex-row gap-4 w-1/2" onSubmit={handleFormSubmit}>
        <input type="email" 
      ...
      {/* sparator */}
      <div className="h2 w-full bg-[#232323]" aria-hidden="true"></div>

      {/* 1st section */}
      <div className="by-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2">
        {/* lift side */}
        <div className="flex-1 text-center md:text-left">
          <h2 className="text-4xl md:text-5xl font-extrabold mb-4">Enjoy on your TV</h2>
          <p className="text-lg md:text-xl">
            watch on smart TV, Playstation, Xbox, Chromecast, Apple TV, Blue-ray player, and more.
          </p>
        </div>
        {/* right side */}
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2">
          ...
          <div className="flex-1 md:text-left text-center">
            <h2 className="text-4xl md:text-5xl font-extrabold md-4 text-balance">
      ...
      <div className="by-10 bg-black text-white">
        ...
        <div className="flex-1 relative overflow-hidden">
          ...
          <video src="" 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 h-4/6 z-10 max-w-[63%]"
            playsInline
            autoPlay={true}
            muted
            loop
      ...
      <div className="py-10 bg-black text-white">
        <div className="flex max-w-6xl mx-auto items-center justify-center flex-col-reverse md:flex-row px-4 md:px-2">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-lg md:text-xl">
              Send kids on advantures with their favorite characters in a space made just for them-free with your membership.
            </p>
          </div>
        </div>
      </div>

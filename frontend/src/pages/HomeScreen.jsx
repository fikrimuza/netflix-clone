  ...
  if (!trendingContent)
    return (
      <div className="h-screen text-white relative">
          <Navbar />
          <div className="absolute top-0 left-0 w-full bg-black/70 flex items-center justify-center -z-10 shimmer" />
      </div> 
    );
  ...
  return (
    <>
      <div className="relative h-screen text-white">
        ...
        <img src={ORIGINAL_IMG_BASE_URL + trendingContent?.backdrop_path} alt="Hero Img" className="absolute top-0 left-0 w-full h-full object-cover -z-50" onLoad={() => {setImgLoading(false)}} />
